const highlights = [
  {
    title: "Education",
    value: "MCA @ VIT",
    description: "Building alongside academics.",
  },
  {
    title: "Development",
    value: "Web + Mobile",
    description: "Next.js, Flutter, Flask & PostgreSQL.",
  },
  {
    title: "Design",
    value: "UI/UX + Branding",
    description: "Clean interfaces and visual identities.",
  },
];
    ...
    <section id="about" className="about-section">
      ...
      <div className="about-shell">
        ...
        <div className="about-top-grid">
          ...
          <div className="about-heading">
            ...
            <p>
              Curious by nature, creative by choice — I enjoy
              turning ideas into clean, useful and thoughtfully
        ...
        <div className="about-layout">
          ...
          <div className="about-story-card">
            ...
            <p className="about-story-text">
              Every project teaches me something new — from
              solving technical challenges to improving the way
              I approach design. This portfolio reflects the
              ideas, experiments and experiences shaping my
        ...
        <div className="about-journey-card desktop-only">
          ...
          <div className="about-journey-head">
            ...
            <span>
              From academics to real-world products
            </span>
      ...
      <style>{`
        ...
        .about-avatar-frame {
          ...
          box-shadow:
            0 0 44px rgba(114,9,183,0.32),
            0 0 90px rgba(76,201,240,0.12);
        ...
        .about-avatar-frame:hover {
          ...
          box-shadow:
            0 0 58px rgba(114,9,183,0.42),
            0 0 110px rgba(76,201,240,0.16);
        }
